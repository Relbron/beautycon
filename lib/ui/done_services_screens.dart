...
import 'package:beautycon/view_model/done_service/done_service_view_model_imp.dart';
...
class DoneService extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ScopedReader watch) {
    //When refresh, clear servicesSelected, because Chip Choices do not hold state
                          ...
                          Row(
                            ...
                            children: [
                              Consumer(builder: (context, watch, _) {
                                ...
                                return Text(
                                  'Price \$${context.read(selectedBooking).state.totalPrice == 0 ? doneServiceViewModel.calculateTotalPrice(servicesSelected) : context.read(selectedBooking).state.totalPrice}',
                        ...
                        children: [
                                ...
                                .map((e) => Padding(
                                      ...
                                      child: ChoiceChip(
                                        ...
                                        onSelected: (isSelected) =>
                                            doneServiceViewModel.onSelectedchip(
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              onPressed: doneServiceViewModel.isDone(context)
                                  ? null
                                  : servicesWatch.length > 0
                                      ? () => doneServiceViewModel
                                          .finishService(context, scaffoldKey)
                                      : null,
                              child: Text(
                                'FINISH',
                                style: GoogleFonts.robotoMono(),
